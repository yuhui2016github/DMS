...
public class RefreshHeaderView extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        // 初始情况，设置下拉刷新view高度为0
        mContainer = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.catalogue_refresh_header, null, false);
