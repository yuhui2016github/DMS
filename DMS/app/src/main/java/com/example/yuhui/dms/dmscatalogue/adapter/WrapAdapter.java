...
import com.example.yuhui.dms.dmscatalogue.view.LoadingMoreFooterView;
...
public class WrapAdapter extends RecyclerView.Adapter{
    ...
    public WrapAdapter(ArrayList<View> headerViews, ArrayList<LoadingMoreFooterView> footViews, RecyclerView.Adapter adapter) {
